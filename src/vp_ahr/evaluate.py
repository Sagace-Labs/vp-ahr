"""Measure a version under an evaluation protocol.
    ...
    python -m vp_ahr.evaluate --version v1
...
from vp_ahr.train import OUTPUT_LABELS
...
def evaluate_version(
    ...
    *,
    ...
    table = ahr_data.example() if use_example else ahr_data.load()
    ...
    primary = scored[ahr_contract.PRIMARY]
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m vp_ahr.evaluate")
    ...
    version = args.version or vp_ahr.current_version()
