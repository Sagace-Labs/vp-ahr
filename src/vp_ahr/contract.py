...
OUTPUTS: list[dict[str, Any]] = [
    {
        ...
        "range": [0.0, 1.0],
        "semantics": (
            "P(activates the aryl hydrocarbon receptor signalling pathway in the "
            "Tox21 qHTS reporter). The readout is transcriptional output."
        ),
    ...
    },
    {
        ...
        "semantics": (
            ...
            "compound scoring high on both readouts activated the reporter in a cell "
            "that was also dying"
        ),
        "missing": "NaN when RDKit cannot parse the input SMILES",
    },
